...
public class OrderServiceImpl implements IOrderService {
    ...
    @Autowired
    PayInfoMapper payInfoMapper = null;
    ...
    @Autowired
    ShippingMapper shippingMapper = null;
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        // (必填) 商户网站订单系统中唯一订单号，64个字符以内，只能包含字母、数字、下划线，不能重复.
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        if (order == null) {
            return ServerResponse.createByErrorMessage("未找到订单, 回调忽略");
        }
        ...
        if (Const.AliPayCallback.TRADE_STATUS_TRADE_SUCCESS.equals(tradeStatus)) {
            order.setPaymentTime(DateTimeUtil.strToDate(params.get("gmt_create")));
